...
clc;
clear all;
L3 = 0.48; % Average Length between hip and knee joint (in metres)
L4 = 0.35; % Average Length between knee and ankle (in metres)
basex = 0;
basey = 0;
basez = 0;
    ...
    for j = theta2min:theta2max
        for k = theta3min:theta3max
            for l = theta4min:theta4max
                ...
                T34 = [cosd(l) -sind(l) 0 L3; 0 0 -1 0; sind(l) cosd(l) 0 0; 0 0 0 1];
                T05 = T01*T12*T23*T34*T45;
                endeffector = T05*base;
